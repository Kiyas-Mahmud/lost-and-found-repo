    ...
    <div class="main-content">
        <div class="container">
            <div class="page-header">
                <div>
                    <h1><i class="fas fa-check-circle text-success"></i> Report Found Item</h1>
                ...
                <form id="postItemForm" class="post-item-form" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text">Be as detailed as possible to help the owner identify their item</small>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="location" class="required">Location Where Found</label>
                        ...
                        <div class="form-group">
                            <label for="eventDate" class="required">When Did You Find It?</label>
                            <input 
                                type="date" 
                                id="eventDate" 
                                name="event_date" 
                            ...
                            <small class="form-text">Date when you found the item</small>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-success btn-lg" id="submitBtn">
                            <i class="fas fa-paper-plane"></i> Post Found Item
                        </button>
                    </div>
                </form>
            </div>
